...
age_df_path = base_path + 'age_df.tsv'
...
nx.write_gpickle(gc, base_path + 'gender_pokec_graph.p')

g = nx.read_gpickle(base_path + 'gender_pokec_graph.p')

#### make age graph ############################################################

attr_dict = {}
with open(age_df_path, 'r') as f:
    next(f) # skip header
    for line in f:
...
nx.write_gpickle(gc, base_path + 'age_pokec_graph.p')

g = nx.read_gpickle(base_path + 'age_pokec_graph.p')
